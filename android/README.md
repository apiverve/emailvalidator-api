...
```gradle
dependencies {
    implementation 'com.github.apiverve:emailvalidator-api:1.1.14'
}
```
...
```java
import com.apiverve.emailvalidator.EmailValidatorAPIClient;
import com.apiverve.emailvalidator.APIResponse;
import com.apiverve.emailvalidator.APIException;

// Initialize the client
EmailValidatorAPIClient client = new EmailValidatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("email", "support@myspace.com");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/emailvalidator](https://docs.apiverve.com/ref/emailvalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/emailvalidator](https://docs.apiverve.com/ref/emailvalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/emailvalidator-api/issues)

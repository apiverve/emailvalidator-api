...
class emailvalidatorWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/emailvalidator');
        }
        ...
        this.validationRules = {"email":{"type":"string","required":true,"format":"email"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/emailvalidator`);
        }
    }
...
module.exports = emailvalidatorWrapper;

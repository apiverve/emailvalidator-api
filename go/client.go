...
const (
	baseURL        = "https://api.apiverve.com/v1/emailvalidator"
	defaultTimeout = 30 * time.Second
)

// Client is the Email Validator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Email Validator API client.
...
// Execute makes a request to the Email Validator API with typed parameters.
//

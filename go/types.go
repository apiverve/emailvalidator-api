// Package emailvalidator provides a Go client for the Email Validator API.
//
// For more information, visit: https://emailvalidator.apiverve.com?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Email Validator API.
//
// Parameters:
//   - email (required): string - The email address to validate (e.g., support@myspace.com) [format: email]
type Request struct {
...
// ResponseData contains the data returned by the Email Validator API.
type ResponseData struct {
	...
	IsMxValid bool `json:"isMxValid"`
	IsSmtpValid bool `json:"isSmtpValid"`
	IsRegexValid bool `json:"isRegexValid"`
	Smtp SmtpData `json:"smtp"`
	IsCompanyEmail bool `json:"isCompanyEmail"`
	IsFreeEmail bool `json:"isFreeEmail"`
	Checksum int `json:"checksum"`
}

// SmtpData represents the smtp object.

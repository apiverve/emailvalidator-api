...
namespace APIVerve\Emailvalidator;
...
/**
 * Client for the Email Validator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://emailvalidator.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/emailvalidator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\EmailvalidatorClient] {$message}\n";
        }
    }
}
